...
# Generate another random UUID for remove funds transactionId
ANOTHER_REMOVE_FUNDS_TRANSACTION_ID=$(uuidgen)
...
ANOTHER_REMOVE_FUNDS_PAYLOAD=$(jq -n --arg tx_id "$ANOTHER_REMOVE_FUNDS_TRANSACTION_ID" '{"transactionId": $tx_id, "funds": "10.15"}')
